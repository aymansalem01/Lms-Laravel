<header class="relative z-50 bg-surface-800/80 backdrop-blur-md border-b border-white/5 px-4 lg:px-6 py-3 flex items-center justify-between gap-4">
    ...
    <div class="flex items-center gap-1 sm:gap-2">
        ...
        <div class="relative">
            ...
            <div x-show="userMenuOpen" x-cloak
                ...
                <div class="py-1">
                    <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-200 hover:text-white hover:bg-surface-700 transition-colors">
                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                        {{ __('messages.profile') }}
                    </a>
                    <a href="{{ route('notifications.index') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-200 hover:text-white hover:bg-surface-700 transition-colors">
                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                        {{ __('messages.notifications') }}
                    </a>
                    <a href="{{ route('portfolio.edit') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-200 hover:text-white hover:bg-surface-700 transition-colors">
                ...
                <div class="border-t border-white/5 py-1">
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="flex items-center gap-3 w-full px-4 py-2 text-sm text-gray-200 hover:text-white hover:bg-surface-700 transition-colors">
