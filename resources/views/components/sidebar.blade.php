<nav class="h-full w-60 bg-surface-900 border-r border-white/5 flex flex-col overflow-y-auto">
    ...
    <div class="flex-1 px-3 py-4 space-y-1">
        ...
        <a href="{{ route('courses.index') }}" class="{{ request()->routeIs('courses.*') && !request()->routeIs('courses.catalog') ? 'nav-item-active' : 'nav-item' }}">
            <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
            <span>{{ __('messages.my_courses') }}</span>
        </a>
        <a href="{{ route('assignments.index') }}" class="{{ request()->routeIs('assignments.*') ? 'nav-item-active' : 'nav-item' }}">
        ...
        <a href="{{ route('roster.index') }}" class="{{ request()->routeIs('roster.*') ? 'nav-item-active' : 'nav-item' }}">
            ...
            <span>{{ __('messages.roster') }}</span>
        </a>
        <a href="{{ route('grading.index') }}" class="{{ request()->routeIs('grading.*') ? 'nav-item-active' : 'nav-item' }}">
        ...
        <a href="{{ route('profile.edit') }}" class="{{ request()->routeIs('profile.*') ? 'nav-item-active' : 'nav-item' }}">
