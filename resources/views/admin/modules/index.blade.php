<x-layouts.dashboard>
    <x-slot name="title">Module Management — Luminus LMS</x-slot>
    ...
    {{-- Create Module Modal --}}
    <div x-data="{ open: false }" @open-create-module.window="open = true" x-show="open" x-cloak
         x-effect="open && $nextTick(() => $refs.moduleCourse.focus())"
        ...
        <div class="relative bg-surface-800 border border-white/10 rounded-xl p-6 w-full max-w-lg shadow-2xl">
            ...
            <form method="POST" action="{{ route('admin.modules.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <select id="module_course_id" x-ref="moduleCourse" name="course_id" class="input-dashboard">
