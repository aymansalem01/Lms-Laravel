<x-layouts.dashboard>
    <x-slot name="title">{{ $questionBank->name }} — Luminus LMS</x-slot>
    ...
    <div class="mb-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('admin.question-bank.import-example') }}" class="inline-flex items-center gap-1.5 text-sm bg-surface-700 hover:bg-surface-600 text-gray-300 px-3 py-2 rounded-xl transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                    Example CSV
                </a>
                <form method="POST" action="{{ route('admin.question-bank.import', $questionBank) }}" enctype="multipart/form-data" class="inline">
                    @csrf
                    <label class="inline-flex items-center gap-1.5 text-sm bg-surface-700 hover:bg-surface-600 text-gray-300 px-3 py-2 rounded-xl transition-colors cursor-pointer">
